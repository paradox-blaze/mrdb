      ...
      <div className="bg-secondary/90 w-full max-w-2xl rounded-2xl border border-white/10 shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="p-6 overflow-y-auto custom-scrollbar space-y-8">
          ...
          <div>
            <div className="flex justify-between items-end mb-4">
              <h3 className="text-lg font-semibold text-white border-l-4 border-accent pl-3">
                Ratings
              </h3>
          ...
          {/* Review Text */}
          <div>
            <h3 className="text-lg font-semibold text-white border-l-4 border-accent pl-3 mb-4">
              Thoughts
            </h3>
            <textarea
              value={reviewText}
              ...
              disabled={readOnly} // <--- DISABLED IF READ ONLY
              placeholder={
                readOnly ? "No written review." : "Write your review here..."
              }
        ...
        <div className="p-6 border-t border-white/10 bg-black/20 flex justify-between items-center">
          ...
          <div className="flex gap-3">
            <button
              onClick={onClose}
              className="px-6 py-2 rounded-full text-gray-300 hover:text-white font-medium hover:bg-white/5 transition-colors"
            >
